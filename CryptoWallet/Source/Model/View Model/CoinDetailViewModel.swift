...
//        ]
        ...
        networkService.fetchData(from: "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=5&page=1&sparkline=false&price_change_percentage=24h") {
            (result: Result<[Coin], NetworkError>) in
